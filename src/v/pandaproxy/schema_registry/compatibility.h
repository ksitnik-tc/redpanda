...
constexpr std::string_view to_string_view(avro_incompatibility_type t) {
    switch (t) {
...
constexpr std::string_view to_string_view(proto_incompatibility_type t) {
    switch (t) {
...
std::string_view to_string_view(json_incompatibility_type t);
