...
std::string_view to_string_view(partition_balancer_status status);
...
std::string_view to_string_view(change_reason rep);
/**
...
std::string_view to_string_view(reallocation_error rep);
