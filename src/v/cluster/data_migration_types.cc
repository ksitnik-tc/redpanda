...
std::string_view to_string_view(state e) {
    switch (e) {
    case state::planned:
        return "planned";
...
std::string_view to_string_view(migrated_replica_status e) {
    switch (e) {
...
std::string_view to_string_view(migrated_resource_state e) {
    switch (e) {
