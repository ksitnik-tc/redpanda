...
std::string_view to_string_view(partition_balancer_status e) {
    switch (e) {
...
std::string_view to_string_view(change_reason e) {
    switch (e) {
...
std::string_view to_string_view(reallocation_error e) {
    switch (e) {
