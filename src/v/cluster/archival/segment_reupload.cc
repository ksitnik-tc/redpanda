...
std::string_view to_string_view(candidate_creation_error e) {
    ...
    case candidate_creation_error::concurrency_error:
        return "collected segments are modified concurrently";
    }
}
